...
class SoundManager:
    ...
    def __init__(self):
        ...
        self.current_music = None  # Track current music type
        self.load_sounds()
    ...
    def load_menu_music(self):
        ...
        if os.path.exists(music_file):
            try:
                ...
                print("[SoundManager] ✅ Menu music loaded")
            except pygame.error as e:
    ...
    def load_ingame_music(self):
        ...
        music_file = os.path.join("assets", "sounds", "In_Game_Music.mp3")
        if os.path.exists(music_file):
            try:
                pygame.mixer.music.load(music_file)
                pygame.mixer.music.set_volume(self.music_volume)
                ...
                print("[SoundManager] ✅ In-game music loaded")
            except pygame.error as e:
    ...
    def load_chase_music(self):
        ...
        if os.path.exists(music_file):
            try:
                ...
                print("[SoundManager] ✅ Chase music loaded")
            except pygame.error as e:
